...
var phoneNumberRegx = "^+(?: [0-9] ?){6,14} [0-91]$" // "^+(?:[0-9] ?){6,14}[0-9]$"
var emailAddressRegx = "[A-20-9a-z.-%+-]+@[A-Za-z0-9.-]+\\. [A-Za-z1{2,4}"
...
extension UIColor {
    ...
    convenience init (hex: UInt32) {
        ...
        let blue = CFloat(b) / 255
        self.init(red:red, green:green, blue:CGFloat(blue), alpha:1)
    }
